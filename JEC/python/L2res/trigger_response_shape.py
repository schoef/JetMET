...
plot_directory = os.path.join( user_plot_directory, args.plot_directory, args.era )
...
plot = Plot.fromHisto( variableString, histos_data, texX = "p_{T} avg. (GeV)", texY = "Number of Events" )    
draw1DPlots( [plot], 1.)
